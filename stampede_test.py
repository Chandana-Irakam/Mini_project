...
def analyze_video(video_path):
    """Analyze video for stampede detection and return structured results"""
    try:
        # Load the trained CNN model
        cnn_model = tf.keras.models.load_model("stampede_model_best.h5")
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print(json.dumps({"error": "Usage: python stampede_test_modified.py <video_path>", "success": False}))
        sys.exit(1)
